...
| ?- tphrase_set_string([w('NS','boys')]), parse(noun_phrase('-SBJ',established)).
...
| ?- tphrase_set_string([w('N','Business'),w('NS','people'),w('VBP',Y,'make'),w('PUNC','.')]), parse(sentence).
...
All sources (c) 2025 Alastair Butler
